...
def main():
    # gestures_history_list = []
    left_hand_gesture_history = []
    right_hand_gesture_history = []
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                #print(hand_landmarks)                                                                                                         #can be used to print landmark coordinates
                ...
                # Hand sign classification and put in left or right hand list
                hand_sign_id = keypoint_classifier(pre_processed_landmark_list)
                if hand_sign_id % 2 == 0:
                    right_hand_gesture_history.append(hand_sign_id)
                else:
                    left_hand_gesture_history.append(hand_sign_id)
                ...
                #determine hand gesture and process gesture in 'key_press.py'
                hand_gesture = keypoint_classifier_labels[hand_sign_id]                                                                                                                                 #determines what gesture was used and processes gesture
